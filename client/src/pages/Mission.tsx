...
const phases = [
  ...
  { id: "studio", tag: "02 / ESTÚDIO", title: "A sessão precisa de memória", text: "Cada entrega recebe versão, hash, tipo MIME, histórico e contexto. O som continua sendo seu; o sistema apenas protege o caminho.", icon: Waves },
  { id: "portal", tag: "03 / PORTAL", title: "O cliente entra sem tocar no núcleo", text: "Projetos, comentários por timestamp, aprovações e limites de revisão acontecem em uma superfície clara, com permissões reais.", icon: Shield },
  { id: "catalog", tag: "04 / CATÁLOGO", title: "A batida vira um contrato", text: "O Beat Store apresenta previews com watermark, licenças exclusiva e não exclusiva, checkout de teste e entrega assinada.", icon: Music2 },
  { id: "command", tag: "05 / COMANDO", title: "A decisão volta para Duck", text: "O produtor acompanha atividade, receita, saúde dos clientes e pode consultar o assistente interno sem sair do estúdio.", icon: Terminal },
];
...
export default function Mission() {
  ...
  useEffect(() => {
    setStarted(localStorage.getItem("duck-mission-started") === "true");
